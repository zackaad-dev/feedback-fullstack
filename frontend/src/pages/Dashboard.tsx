...
import { Box, Typography, Stack, Card, CardContent, Avatar, Button } from "@mui/material";
              ...
              >
                <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
                  <Stack direction="row" spacing={2} alignItems="flex-start">
                    <Avatar sx={{ bgcolor: "text.primary", color: "background.paper", fontWeight: 800, width: 38, height: 38 }}>
                    ...
                    <Box flex={1}>
                      ...
                      <Stack direction="row" alignItems="center" spacing={3}>
                        ...
                        >
                          ...
                          <Typography variant="body2" sx={{ fontWeight: 600, fontSize: "0.875rem", lineHeight: 1 }}>
